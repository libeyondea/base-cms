...
export const SubTable = <T extends Record<string, any>>({ parentRow, data = [], colSpan, renderSubTable }: SubTableProps<T>) => {
...
const DefaultSubTable = ({ data, parentRowIsSelected }: DefaultSubTableProps) => {
	const theme = useTheme();
