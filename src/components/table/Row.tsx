...
import { Box, Checkbox, CircularProgress, IconButton, Popover, SpeedDial, SpeedDialAction, TableCell, TableRow, Tooltip, Typography } from '@mui/material';
...
// Function to get styling for action cell based on theme
